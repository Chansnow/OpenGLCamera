...
public:
	 ...
	 */
	virtual MRESULT	Init(const MInt32 nInterfaceVersion)=0;

	/*
	 * Initialize the SDK.
	 * [IN] nInterfaceVersion: ABS_INTERFACE_VERSION.
	 * [IN] nMaxFaceNum: The max face number supported, should not more than ABS_MAX_VIDEO_FACE_NUM.
	 */
	virtual MRESULT	Init(const MInt32 nInterfaceVersion, MInt32 nMaxFaceNum)=0;
